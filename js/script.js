...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Hoy cumplimos 8 meses juntos, y sinceramente han sido de las mejores etapas de mi vida. Gracias por cada momento, por cada risa, por tu cariño y por estar conmigo incluso en los días más simples, porque contigo todo se siente especial.

Me gusta saber que te tengo, que puedo compartir contigo mis pensamientos, mis tonteras y mis sueños. En estos 8 meses te has vuelto una persona demasiado importante para mí, y cada día te quiero más.

Espero que sigamos creando recuerdos juntos, apoyándonos y disfrutando de todo lo que venga. Gracias por ser tú. 💖`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Te amo mucho, mi amor. ❤️"; 
...
// Cuenta del tiempo juntos
function showCountdown() {
  const container = document.getElementById("countdown");
  const startDate = new Date("2025-09-22T05:00:00");
  ...
  function update() {
    ...
    container.innerHTML =
      "💕 Llevamos juntos:<br>" +
      "<b>" + totalDays + " días, " + hours + "h " + seconds + "s</b>";
